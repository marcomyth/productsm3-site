  ...
  cases: [
    {
      ...
      metricAccent: true,
      description: "O marco legal de 2020 fixou a meta e tornou o consórcio intermunicipal o caminho para municípios pequenos viabilizarem a gestão de resíduos. Só em 2025, o Novo PAC destinou R$ 22,1 bilhões ao setor.",
    ...
    },
    {
      ...
      metricAccent: false,
      description: "Fogões, geladeiras e máquinas de lavar cresceram acima da média dos bens duráveis, puxados por um ciclo de troca de equipamento antigo.",
    ...
    },
    {
      ...
      metricAccent: true,
      description: "O segmento premium foi de 51,2 mil para 54,6 mil unidades em 2025 — quase o triplo do avanço registrado pelo mercado automotivo como um todo.",
    ...
    },
    {
      ...
      metricAccent: false,
      description: "Foram 53,6 milhões de unidades vendidas no período, com categorias novas crescendo mais rápido que o carro-chefe histórico do setor.",
      platform: "Fonte: Eletros, 2026",
      badge: "Dado de mercado",
    },
    {
      ...
      metricAccent: true,
      description: "O setor movimenta mais de R$ 7 bilhões por ano no Brasil, e nichos específicos correm bem acima da média: a moda praia plus size avançou mais de 20% em dois anos.",
    ...
    },
    {
      ...
      metricAccent: false,
      description: "O varejo moveleiro movimentou R$ 127,7 bilhões no ano, e a indústria fechou 2025 com R$ 92,1 bilhões em faturamento.",
    ...
    },
    {
      ...
      metricAccent: true,
      description: "Maior patamar já registrado pela série do IBGE, puxado por hospedagem, alimentação e transporte de passageiros.",
